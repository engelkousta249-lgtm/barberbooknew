  ...
  async function handleFinish() {
    ...
    try {
      ...
      const { data: shop, error: shopErr } = await supabase.from("barbershops").insert({
        ...
        logo_url:logoUrl,num_barbers:2,plan:"duo",description:"",rating:5.0,
      }).select().single()
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .step-item.active{background:rgba(245,158,11,.1);border-color:rgba(245,158,11,.25);}
        ...
        .step-item.active .step-icon{background:rgba(245,158,11,.12);border-color:rgba(245,158,11,.3);}
        ...
        .card-icon{width:48px;height:48px;border-radius:14px;margin-bottom:16px;display:flex;align-items:center;justify-content:center;font-size:24px;background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.2);}
        ...
        .svc-inp:focus{border-color:var(--gold);}
            ...
            {!done ? (
              <>
                ...
                {step===5 && (<>
                  ...
                  <div className="card-sub">Φωτογραφίες και τα ονόματα των 2 barbers σου</div>
                  ...
                  <div className="barber-section">
                    <div className="barber-section-title">👥 Ομάδα Barbers (Duo)</div>
